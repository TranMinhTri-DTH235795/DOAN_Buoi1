...
using static QuanLyCuaHang.Data.HoaDon_ChiTiet;
    ...
    public partial class frmHoaDon_ChiTiet : Form
    {
        ...
        private void frmHoaDon_ChiTiet_Load(object sender, EventArgs e)
        {
            ...
            if (id != 0) // Đã tồn tại chi tiết 
            {
                ...
                txtThanhToan.Text = hoaDon.PhuongThucThanhToan;
        ...
        {
            // ===== VALIDATE — dùng return thay vì else if =====
            ...
            {
                MessageBox.Show("Đơn giá bán sản phẩm phải lớn hơn 0.", "Lỗi",
                    MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }

            int baoHanh = 0;
            if (!int.TryParse(txtBaoHanh.Text.Trim(), out baoHanh))
            {
                MessageBox.Show("Bảo hành phải là số nguyên (số tháng).", "Lỗi",
                    MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            if (chiTiet != null)
            {
                ...
                chiTiet.ThoiGianBaoHanh = baoHanh;
            ...
            else
            {
                if (id != 0) // Đã tồn tại chi tiết thì chỉ cập nhật 
                {
                    ...
                    if (hd != null)
                    {
                        ...
                        hd.PhuongThucThanhToan = txtThanhToan.Text;
                        ...
                        foreach (var item in hoaDonChiTiet.ToList())
                        {
                            ...
                            ct.ThoiGianBaoHanh = item.ThoiGianBaoHanh;
